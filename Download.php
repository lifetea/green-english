...
<title><?php echo _('Download side channel blower performance curves,data sheet,technical data for pressure and vacuum_GREENCO');?></title>
<meta name="keywords" content="<?php echo _('side channel blower download,regenerative blower,Ring Blower catalogue,Air blower manual,blower dimensions,regenerative blower,vacuum pump,motors,performance curves,technical data,blower curves');?>" />
<meta name="description"content="<?php echo _('Downlod Greenco side channel blower,regenerative blower,Ring blower technical data,Air blower performance curves,catalogue & manual.Full range of products,the pressure upto 150Kpa,volume flow upto 2500m3/h,power range from 200w to 25kw');?>" />
...
<div id="downloadall">
    <div id="download" style="height:1150px;">
        <img src="image/download_ico.jpg" style="margin:10px 0 0 10px;border:1px solid #666;" alt="side channel blower Downloads"/>
         <p style="background:url(image/download_PDF_ico.png) no-repeat 0px 22px;position:absolute;top:320px;left:10px;color:#333;font-size:13px;height:50px;line-height:65px;width:450px;margin-left:10px;font-family:tahoma;text-indent:22px;border-bottom:1px solid #666;"><a href="upfile/side channel blower Complete Catalog.pdf" style="font-size:13px;font-weight:600;" id="catalog" target="_blank"><?php echo _('Complete Catalog (2RB,4RB and Belt Drive)');?> </a></p>

         <div>
         <div class="overview">
             <div style="float:left;margin:70px 30px 40px 21px;" id="overview1">
             <h4 style="background:url(image/arrow04.gif) no-repeat 5px 12px;padding-left:6px;"><?php echo _('Overview 2RB Series');?></h4>
             <table>
             <tr class="one"><td><a href="<?php echo _('upfile');?>/overview_2rb/side channel blower 2RB_1AC_pressure_selection_diagram.pdf" target="_blank">2RB <?php echo _('1AC Pressure Operation');?></a></td>
             <td><a href="<?php echo _('upfile');?>/overview_2rb/side channel blower 2RB_3AC_Pressure_selection_diagram.pdf" target="_blank">2RB <?php echo _('3AC Pressure Operation');?></a></td></tr>
             <tr class="one"><td><a href="<?php echo _('upfile');?>/overview_2rb/side channel blower 2RB_1AC_Vacuum_selection_diagram.pdf" target="_blank">2RB <?php echo _('1AC Vacuum Operation');?></a></td>
             <td><a href="<?php echo _('upfile');?>/overview_2rb/side channel blower 2RB_3AC_Vacuum_selection_diagram.pdf" target="_blank">2RB <?php echo _('3AC Vacuum Operation');?></a></td></tr>
             </table>
             </div>
             <div style="float:left;margin:70px 30px 40px  30px;" id="overview1">
             <h4 style="background:url(image/arrow04.gif) no-repeat 5px 12px;padding-left:6px;"><?php echo _('Overview 4RB Series');?></h4>
             <table>
             <tr class="one"><td><a href="<?php echo _('upfile');?>/overview_4rb/side channel blower 4RB_1AC_pressure_selection_diagram.pdf" target="_blank">4RB <?php echo _('1AC Pressure Operation')?></a></td>
             <td><a href="<?php echo _('upfile');?>/overview_4rb/side channel blower 4RB_3AC_Pressure_selection_diagram.pdf" target="_blank">4RB <?php echo _('3AC Pressure Operation')?></a></td></tr>
             <tr class="one"><td><a href="<?php echo _('upfile');?>/overview_4rb/side channel blower 4RB_1AC_Vacuum_selection_diagram.pdf" target="_blank">4RB <?php echo _('1AC Vacuum Operation')?></a></td>
             <td><a href="<?php echo _('upfile');?>/overview_4rb/side channel blower 4RB_3AC_Vacuum_selection_diagram.pdf" target="_blank">4RB <?php echo _('3AC Vacuum Operation')?></a></td></tr>
             </table>
             </div>
         </div>
         ...
         <H3 style="color:#eee;clear:both;background:#666;border:1px solid #555;text-indent:5px;"><?php echo _('Liquid Ring Vacuum Pump');?></H3>
         <div>
         <div class="left" >
