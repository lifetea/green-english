...
<title>Honours|Greenco honour_GREENCO</title>
<meta name="keywords" content="Honours,Greenco honour,side channel blower honour,High Tech,Famous brand,trademark,regenerative blower,air blower,GREENCO" />
<meta name="description"content="Zhejiang Greenco Industry Co Ltd approved by ISO9001:2008 quality system，side channel blower approved by UL、CE、TUV、GS certifications,high quality & competitive price,export to more than 100 countries." />
...
<style>
   ...
   #Honour _all{background:#ccc;height:770px;}
	...
	#Honour  .right p{padding:3px;line-height:21px;text-indent:10px;}
...
<div id="Honour _all" >
   <div id="Honour">
       ...
       <div class="right">
             <h5>Honour <span style="margin-left:540px;font-weight:500;font-size:13px;"><a href="index.php">Home</a> > <a href="Honour.php">Honour</a></span></h5>
					<div style="margin-left:50px;"><img src="image/Honour1.jpg" alt="Zhejiang Brand products"  /><p>Zhejiang Brand products</p></a></div>
					<div  style="margin-left:190px;"><img src="image/Honour2.jpg" alt="Beautiful  taxpayers'"  /><p>Beautiful  taxpayers'</p></a></div>
					<div style="margin-left:10px;"><img src="image/Honour7.jpg" alt="High and new tech enterprises"  /><p>High and new tech enterprises</p></a></div>
					<div style="margin-left:80px;"><img src="image/Honour3.jpg" alt="Enterprise technology center"  /><p>Enterprise technology center</p></a></div>
       		        <div style="margin-left:10px;"><img src="image/Honour6.jpg" alt="The zhejiang province famous trademark"  /><p>The zhejiang province famous trademark</p></a></div>
       		        <div style="margin-left:90px;"><img src="image/Honour8.jpg" alt="R&D Center"  /><p>R&D Center</p></a></div>
       		        <div style="margin-left:10px;"><img src="image/Honour4.jpg" alt="AA Rated(Keep the contract heavy credit unit)"  /><p>AA Rated(Keep the contract heavy credit unit)</p></a></div>
       		        <div style="margin-left:100px;"><img src="image/Honour5.jpg" alt="New mechanical and electrical products"  /><p>New mechanical and electrical products</p></a></div>
       </div>
   </div>
</div>
<!-- 荣誉内容end -->
