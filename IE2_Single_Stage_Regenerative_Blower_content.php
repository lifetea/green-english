...
<div id="Side_Channel_Blower_2RB_Single_Stage_all" >
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
             ...
             else{ echo  '<a rel="shadowbox" href="product_image/dimensions_ie2/2RB210_big.jpg"><img alt="Dimension for side channel blower '.$_rows['type'].' " class="border" src="product_image/dimensions_ie2/2RB210_small.jpg"  title="Click to Enlarge"/></a>';}
             ?>
             <!-- 尺寸图技术参数判断 -->
             <?php  if($_rows['type']=='2RB 610-7AT06' or $_rows['type']=='2RB 610-7AT16' or $_rows['type']=='2RB 610-7AT26' or $_rows['type']=='2RB 630-7AT06' or $_rows['type']=='2RB 630-7AT16' or $_rows['type']=='2RB 630-7AT26' or $_rows['type']=='2RB 710-7AT06' or $_rows['type']=='2RB 710-7AT16' or $_rows['type']=='2RB 710-7AT26' or $_rows['type']=='2RB 710-7AT37' or $_rows['type']=='2RB 730-7AT06' or $_rows['type']=='2RB 730-7AT16' or $_rows['type']=='2RB 730-7AT26' or $_rows['type']=='2RB 730-7AT37' or $_rows['type']=='2RB 810-7AT07' or $_rows['type']=='2RB 810-7AT17' or $_rows['type']=='2RB 810-7AT27' or $_rows['type']=='2RB 830-7AT07' or $_rows['type']=='2RB 830-7AT17' or $_rows['type']=='2RB 830-7AT27'){
		            echo    '<table class="data"  cellspacing="0" cellpadding="0" style="margin-top:30px;">'.
		              ...
		              '<tr><td>'.$_rows['type'].'</td><td>'.$_rows['phases'].'</td><td>'.$_rows['O'].'</td><td>'.$_rows['P'].'</td><td>'.$_rows['Q'].'</td><td>'.$_rows['ϕR'].'</td><td>'.$_rows['S'].'</td><td>'.$_rows['U'].'</td><td>'.$_rows['V'].'</td><td>'.$_rows['V1_'].'</td><td>'.$_rows['V1'].'</td><td>'.$_rows['V_1'].'</td><td>'.$_rows['Y_Z'].'</td><td>'.$_rows['X_Holes'].'</td><td>'.$_rows['ϕX'].'</td></tr>'.
		             '</table>';
              }elseif($_rows['type']=='2RB 910-7AT07' or $_rows['type']=='2RB 910-7AT17' or $_rows['type']=='2RB 910-7AT37' or $_rows['type']=='2RB 930-7AT07' or $_rows['type']=='2RB 930-7AT17' or $_rows['type']=='2RB 930-7AT27' or $_rows['type']=='2RB 930-7AT37'){
                      echo '<table class="data"  cellspacing="0" cellpadding="0" style="margin-top:30px;">'.
					...
					'<tr><td>'.$_rows['type'].'</td><td>'.$_rows['phases'].'</td><td>'.$_rows['A'].'</td><td>'.$_rows['B'].'</td><td>'.$_rows['C'].'</td><td>'.$_rows['D'].'</td><td>'.$_rows['E'].'</td><td>'.$_rows['F'].'</td><td>'.$_rows['G'].'</td><td>'.$_rows['H'].'</td><td>'.$_rows['J'].'</td><td>'.$_rows['K'].'</td><td>'.$_rows['L'].'</td><td>'.$_rows['M'].'</td></tr>'.
					...
					'<tr><td>'.$_rows['type'].'</td><td>'.$_rows['phases'].'</td><td>'.$_rows['N'].'</td><td>'.$_rows['O'].'</td><td>'.$_rows['P'].'</td><td>'.$_rows['Q'].'</td><td>'.$_rows['ϕR'].'</td><td>'.$_rows['S'].'</td><td>'.$_rows['U'].'</td><td>'.$_rows['V'].'</td><td>'.$_rows['V1'].'</td><td>'.$_rows['Y_Z'].'</td><td>'.$_rows['X_Holes'].'</td><td>'.$_rows['ϕX'].'</td></tr>'.
					'</table>';
                     }
             ?>
