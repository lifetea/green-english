...
<?php
if($lan == "zh_CN"){
   require 'seo/cn/Inlet_Vacuum_Filter.php';
}else{
   require 'seo/en/Inlet_Vacuum_Filter.php';
}
 ?>
...
<div id="Silencer_all" >
   <div id="Silencer">
       ...
       <div class="right">
             <h5><?php echo _('Inlet Vacuum Filter for Side Channel Blower');?></h5>
             <div  id="mypage" class="mypagination"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 080" target="_blank"><img  src="image/inlet_vacuum_filter_080.png" alt="Side channel blower inlet vacuum filter 2BX4-080"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 080" target="_blank">2BX4-080</a></h4></div>
             <div  id="mypage" class="mypagination"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 081" target="_blank"><img  src="image/inlet_vacuum_filter_081.png" alt="Side channel blower inlet vacuum filter 2BX4-081"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 081" target="_blank">2BX4-081</a></h4></div>
             <div  id="mypage" class="mypagination"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 082" target="_blank"><img  src="image/inlet_vacuum_filter_082.png" alt="Side channel blower inlet vacuum filter 2BX4-082"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 082" target="_blank">2BX4-082</a></h4></div>
             <div  id="mypage" class="mypagination"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 083" target="_blank"><img  src="image/inlet_vacuum_filter_083.png" alt="Side channel blower inlet vacuum filter 2BX4-083"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 083" target="_blank">2BX4-083</a></h4></div>
       </div>
   </div>
</div>
<!-- 应用内容end -->
