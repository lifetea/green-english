...
<?php
if($lan == "zh_CN"){
   require 'seo/cn/Inlet_Vacuum_Filter_content.php';
}else{
   require 'seo/en/Inlet_Vacuum_Filter_content.php';
}
...
<style>
    ...
    #Side_Channel_Blower_2RB_Single_Stage_all{background:#ccc;}
  	#Side_Channel_Blower_2RB_Single_Stage{height:1410px;width:1000px;margin:0 auto;background:#fff;border:1px solid #999;border-top:none;}
	...
	#Side_Channel_Blower_2RB_Single_Stage .right{height:1106px;float:left;width:700px;border-left:1px solid #ccc;padding:0 0 100px 15px;position:relative;}
