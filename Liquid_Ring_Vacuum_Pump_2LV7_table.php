...
<title><?php echo $_GET['type'];?> series Liquid Ring Vacuum Pump</title>
   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
             ...
             <table  cellspacing="0" cellpadding="0" id="data">
                 ...
                 <h3><a href="upfile/Liqudi Ring Vacuum Pump 2LV7 series.pdf" target="_blank" >Download <?php echo $_GET['type'];?> Liquid Ring Vacuum Pump</a></h3>
       </div>
   </div>
</div>
<!-- 应用内容end -->
