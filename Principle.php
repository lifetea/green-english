...
<style>
	...
	#Side_Channel_Blower_2RB_Single_Stage .right{height:580px;float:left;width:700px;border-left:1px solid #ccc;padding:0 0 0 15px;}
  	#Side_Channel_Blower_2RB_Single_Stage .right h5{color:#444;font-weight:600;font-size:14px;margin-top:10px;height:10px;line-height:10px;margin-bottom:8px;}
...
<div id="Side_Channel_Blower_2RB_Single_Stage_all" >
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
       <h5><i>Principle</i> ▪ Side Channel Blower</h5>
       <p style="width:698px;">Gas is taken into the device via the suction branch with built-in silencer <strong>(1)</strong>. In the side channel <strong>(2)</strong> the rotor <strong>(3)</strong> transfers its speed and gas via centrifugal force is pushed toward the compression chamber. This way, along the spiralroute, gas is repeatedly pressed up to the discharge branch <strong>(4)</strong>, from which it is released. With multi-stage blowers, gas flows through multiple compressor chambers placed behind one another, achieving greater pressure differences.</p>
       <img src="image/princip.jpg" style="margin:20px 0 0 40px;"/>
       </div>
   </div>
</div>
<!-- 应用内容end -->
