   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
              <div id="left">
                ...
                <tr><td><strong>Inlet/outlet:</strong> <span><?php echo $_rows['ϕR'];?></span>(inch)</td><td><strong>Sound:</strong> <span><?php echo $_rows['sound_level'];?></span> dB(A)</td></tr>
                <tr><td><strong>Dimension(L*W*H):</strong> <span><?php echo max($_rows['F'],$_rows['F1']).'×'.$_rows['A'].'×'.$_rows['B'];?></span> (mm)</td></tr>
                </table>
             </div>
             <div id="right">
