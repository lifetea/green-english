...
<title>4RB Single Stage Side Channel Blower</title>
...
<style>
    ...
    #Side_Channel_Blower_2RB_Single_Stage .left form p{margin-top:10px;width:240px;padding-left:10px;}
  	...
  	#Side_Channel_Blower_2RB_Single_Stage .right  #mypage img{border:1px solid #bbb;}
  	#Side_Channel_Blower_2RB_Single_Stage .right  #mypage img:hover{filter:alpha(opacity=90);opacity=0.9;}
  	#Side_Channel_Blower_2RB_Single_Stage .right h4 a{font-size:13px;color:#333;display:block;width:200px;text-indent:50px;height:20px;line-height:20px;font-weight:500;background:url(image/arrow04.gif) no-repeat 48px 6px;padding-left:10px;}
  	/*文字分页*/
	#page_text{
		clear:both;
		text-align:center;
   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="left">
             ...
             <h2 style="margin-top:26px;background:#666 url(image/search_top.png) no-repeat 0 2px;padding-left:18px;width:230px;">Search Product</h2>
                 <form mehtod="post"  action="?" class="jqtransform">
       ...
       <div class="right">
             <h5><i>4RB Single Stage</i> ▪ Side Channel Blower</h5>
             <div  id="mypage" class="mypagination"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=210" target="_blank"><img  src="product_image/4RB/4RB210.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=210" target="_blank">4RB 210</a></h4></div>
		     <div  id="mypage" class="mypagination"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=310" target="_blank"><img  src="product_image/4RB/4RB210.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=310" target="_blank">4RB 310</a></h4></div>
