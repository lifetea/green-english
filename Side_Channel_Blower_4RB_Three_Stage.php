...
<title><?php echo _('4RB Three Stage Side Channel Blower'); ?></title>
...
<style>
	...
	#Side_Channel_Blower_2RB_Single_Stage .right{height:870px;float:left;width:700px;border-left:1px solid #ccc;padding:0 0 30px 15px;}
  	...
  	#Side_Channel_Blower_2RB_Single_Stage .right img{border:1px solid #ccc;}
  	#Side_Channel_Blower_2RB_Single_Stage .right  #mypage{float:left;margin:0 0 20px 22px;}
  	#Side_Channel_Blower_2RB_Single_Stage .right  #mypage img:hover{border:1px solid #999;}
  	#Side_Channel_Blower_2RB_Single_Stage .right h4 a{font-size:13px;color:#333;display:block;width:200px;text-indent:60px;height:30px;line-height:30px;font-weight:500;background:url(image/arrow04.gif) no-repeat 58px 11px;padding-left:10px;}
  	/*文字分页*/
	#page_text{
		clear:both;
		text-align:center;
...
<div id="Side_Channel_Blower_2RB_Single_Stage_all" >
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
             <h5><i>4RB <?php echo _('Three Stage');?></i><?php echo _(' ▪ Side Channel Blower');?></h5>
             <div  id="mypage" class="mypagination"><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=530" target="_blank"><img  src="product_image/4RB/4RB530.jpg"/></a><h4><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=530" target="_blank">4RB 530</a></h4></div>
              <div  id="mypage" class="mypagination"><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=630" target="_blank"><img  src="product_image/4RB/4RB630.jpg"/></a><h4><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=630" target="_blank">4RB 630</a></h4></div>
