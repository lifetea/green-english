   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
              <div id="left">
                ...
                <tr><td><strong>Model: </strong><span><?php echo $_rows['type'];?></span></td><td><strong>Stage:</strong> <span>Single</span></td></tr>
                <tr><td><strong>Freq:</strong> <span><?php echo $_rows['Fre_quency'];?></span> (Hz)</td><td><strong>Power:</strong> <span><?php echo $_rows['output'];?></span> (Kw)</td></tr>
                <tr><td><strong>Airflow:</strong> <span><?php echo $_rows['maximum_airflow'];?></span> (m³/h)</td><td><strong>TH.CL:</strong> <span>IP55</span></td></tr>
                <tr><td><strong>Pressure:</strong> <span>+<?php echo $_rows['maximum_pressure'];?></span> (mbar)</td><td><strong>IN.CL:</strong> <span>F or H</span></td></tr>
                <tr><td><strong>Vacuum:</strong> <span><?php echo $_rows['maximum_vacuum'];?></span> (mbar)</td><td><strong>N.weight:</strong> <span><?php echo $_rows['weight'];?></span> (kg)</td></tr>
                <tr><td><strong>Inlet/outlet:</strong> <span><?php echo $_rows['Inlet_outlet'];?></span>(inch)</td><td><strong>Sound:</strong> <span><?php echo $_rows['sound_level'];?></span> dB(A)</td></tr>
                <tr><td><strong>Dimension(L*W*H):</strong> <span><?php echo $_rows['F'].'×'.$_rows['A'].'×'.$_rows['B1'];?></span> (mm)</td></tr>
                </table>
             </div>
             <div id="right">
             ...
             <!-- 尺寸图判断 -->
             <?php
                    echo       '<a rel="shadowbox" href="product_image/dimensions/4RB530_big.jpg"><img alt="Dimension for side channel blower '.$_rows['type'].' " class="border" src="product_image/dimensions/4RB530_small.jpg"  title="Click to Enlarge"/></a>';
             ?>
