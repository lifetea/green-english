...
<title>About Greenco|Side channel blower|Regenerative blower|Air blower|Ring blower_Zhejiang Greenco Industry Co Ltd</title>
...
<meta name="keywords" content="side channel blower,regenerative blower,vacuum pumps,air Blowers,50Hz,60Hz,Greenco" />
...
<style>
    ...
    #about_all{background:#ccc;}
  	#about{height:1160px;width:1000px;margin:0 auto;background:#fff;border:1px solid #999;border-top:none;box-shadow:0px 5px 7px 5px #ccc;}
    #about .left{float:left;width:265px;margin:5px 0 0 10px;padding-bottom:60px;}
  	#about .left H2{text-indent:8px;background:#666;font-size:14px;font-weight:600;width:250px;height:32px;color:#fff;line-height:32px;border:1px solid  #555;}
  	#about .left ul{margin-top:8px;list-style:none;}
  	#about .left ul li {margin-top:13px;background:url(image/jiantou.png) no-repeat 0 2px;padding-left:18px;}
    #about .left form p{margin-top:10px;width:240px;padding-left:10px;}
  	#about .left ul li  a{color:#333;}
  	#about .left .text{border-radius:0px;}
  	#about .left select{margin-left:8px;border-radius:0px;}
	#about .right{float:left;width:700px;border-left:1px solid #ccc;padding:0 0 30px 15px;}
    #about .right h5{margin-top:10px;color:#222;}
	#about .right p{padding:3px;line-height:21px;text-indent:20px;}
