...
<div id="about_all" >
   <div id="about">
       ...
       <div class="right">
             ...
             <div style="margin:5px 0  5px 0;"><div style="float:left;"><img src="image/about_us_image1.jpg"/><p style="font-weight:600;text-indent:20px;font-size:12px;">New Factory 1:Wenling Easten Industial</p></div><div style="float:left;"><img src="image/about_us_image2.jpg" style="margin-left:20px;"/><p style="font-weight:600;text-indent:70px;font-size:12px;">New Factory 2:Shenqiao Zeguo</p></div></div>
