...
<div id="about_all" >
   <div id="about">
       ...
       <div class="right">
             ...
             <div style="margin:5px 0  5px 0;text-align: center;"><div style="float:left;"><img src="image/about_us_image2.jpg"/>
             <p style="font-weight:600;font-size:12px;"><?php echo _('New Factory 1:Wenling Eastern Industrial Zone');?></p></div>
             <div style="float:left;"><img src="image/about_us_image1.jpg" style="margin-left:20px;"/>
             <p style="font-weight:600;font-size:12px;"><?php echo _('New Factory 2:Shenqiao Zeguo');?></p></div></div>
