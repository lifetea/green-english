...
$_result=mysql_query("select type,sound_level,Fre_quency,output,maximum_airflow,maximum_vacuum,maximum_pressure,weight,phases,Inlet_outlet,A,A1,B,B1,C,C1,D,E,F,F1,F11,G,H,H1,J,K,L,M,N,N1,O,P,Q,ϕR,S,U,V,V1,V1_,V3,V3_,Y_Z,X_Holes,ϕX,W  from product where  type like '%{$_GET['series']}%' and output={$_GET['output']} ");
...
<div id="Side_Channel_Blower_2RB_Single_Stage_all" >
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
             ...
             <!-- 尺寸图技术参数判断 -->
             <?php  if($_rows['type']=='2RB 810-7AH07' or $_rows['type']=='2RB 810-7AH17' or $_rows['type']=='2RB 810-7AH27' or $_rows['type']=='2RB 830-7AH07' or $_rows['type']=='2RB 830-7AH17' or $_rows['type']=='2RB 830-7AH27'){
