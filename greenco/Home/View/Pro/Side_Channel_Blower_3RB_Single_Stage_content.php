   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
              <div id="left">
                ...
                <td><strong><?php echo _('Stage');?>:</strong> <span><?php echo _('Single');?></span></td><td>
                ...
                <tr><td><strong><?php echo _('Dimension');?>(L*W*H):</strong> <span><?php  echo $_rows['F1'].'×'.$_rows['A'].'×'.($_rows['B']+$_rows['B1']);?>
                	                         </span> (mm)</td><td>
                </table>
             </div>
             <div id="right">
