...
<title><?php echo (L("COMPANY_INDEX")); ?></title>
<meta name="keywords" content="<?php echo (L("COMPANY_KEYWORDS")); ?>" />
<meta name="description" content="<?php echo (L("COMPANY_DESCRIPTION")); ?>" />
       ...
       <div class="row">
	       ...
	       <ul>
       		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="mypagination">
							...
							<p>
									<strong>
											<a href="news_content?id=<?php echo ($vo["id"]); ?> "><?php echo ($vo["title"]); ?></a>
									</strong>
							</p>
			            	<p><?php echo ($vo["content"]); ?></p>
			            	<p class="row">
				            	<span class="more col-md-2"><?php echo ($vo["time"]); ?></span>
			            	    <a class="more col-md-1 col-md-offset-9"  href="news_content?id=<?php echo ($vo["id"]); ?> "><?php echo (L("SUPPORT_DETAIL")); ?></a>
			            	</p>
