		...
		<div class="form-group">
		    <button type="submit" class="btn btn-default"><?php echo (L("HEADER_SEARCH")); ?></button>
						...
						<div class="col-md-9 split">
								<h3 class="title-1">4RB 	<?php echo (L("PROD_SINGLE_STAGE")); ?> ▪ <?php echo (L("4RB_SIDE_CHANNEL_BLOWER")); ?></h3>
								<div class="row pro-list content">
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=210" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=210" target="_blank">4RB 210</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=310" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" /></a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=310" target="_blank">4RB 310</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=410" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=410" target="_blank">4RB 410</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=510" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB310.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=510" target="_blank">4RB 510</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=610" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB310.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=610" target="_blank">4RB 610</a>
												</h4>
										</div>
