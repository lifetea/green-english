...
<div class="container-fuild">
   <div class="container support">
       <img src="<?php echo (L("SRC_LAN")); ?>/support.jpg"  class="banner" alt="Greenco side channel blower news"/>
       <div class="row">
	       <div class="col-md-3">
...
<li><a href="<?php echo (C("NEWS_ROOT")); ?>/support"><?php echo (L("HEADER_SUPPORT")); ?></a></li>
	       ...
	       <ul>
       		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="mypagination">
							...
							<p>
									<strong>
											<a href="<?php echo (C("NEWS_ROOT")); ?>/news_content?id=<?php echo ($vo["id"]); ?> "><?php echo ($vo["title"]); ?></a>
									</strong>
							</p>
