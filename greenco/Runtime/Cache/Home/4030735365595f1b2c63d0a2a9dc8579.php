...
<title><?php echo (L("HONOUR_TITLE")); ?></title>
<meta name="keywords"	content="<?php echo (L("HONOUR_KEYWORDS")); ?>" />
<meta name="description"	content="<?php echo (L("HONOUR_DESCRIPTION")); ?>" />
			...
			<div class="col-md-9  split">
				 ...
				 <div class="honour-list">
						<div class="col-md-6 row">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour1.jpg" alt="<?php echo (L("HONOUR_BRAND_PRODUCTS")); ?>" />
							<p>
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour2.jpg" alt="<?php echo (L("HONOUR_TAXER")); ?>" />
							<p>
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour7.jpg" alt="<?php echo (L("HONOUR_TECH ENTERPRISES")); ?>" />
							<p>
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour3.jpg" alt="<?php echo (L("HONOUR_TECHNOLOGY_CENTER")); ?>" />
							<p>
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour6.jpg"
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour8.jpg" alt="<?php echo (L("HONOUR_R&D_Center")); ?>" />
							<p>
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour4.jpg"
						...
						<div class="col-md-6">
							<img src="<?php echo (C("IMG_ROOT")); ?>/Honour5.jpg"
