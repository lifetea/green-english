		...
		<div class="form-group">
		    <button type="submit" class="btn btn-default"><?php echo (L("HEADER_SEARCH")); ?></button>
						...
						<div class="col-md-9 split">
								<h3 class="title-1">4RB 	<?php echo (L("PROD_THREE_STAGE")); ?> ▪ <?php echo (L("4RB_SIDE_CHANNEL_BLOWER")); ?></h3>
								<div class="row pro-list content">
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=530" target="_blank">
												<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB530.jpg"/></a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=530" target="_blank">4RB 530</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=630" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB630.jpg"/>
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=630" target="_blank">4RB 630</a>
												</h4>
										</div>
