		...
		<div class="form-group">
		    <button type="submit" class="btn btn-default"><?php echo (L("HEADER_SEARCH")); ?></button>
						...
						<div class="col-md-9 split">
								<h3 class="title-1">4RB 	<?php echo (L("PROD_DOUBLE_STAGE")); ?> ▪ <?php echo (L("4RB_SIDE_CHANNEL_BLOWER")); ?></h3>
								<div class="row pro-list content">
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=220" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB220.jpg"/>
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=220" target="_blank">4RB 220</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=320" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB320.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=320" target="_blank">4RB 320</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=420" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB420.jpg"  /></a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=420" target="_blank">4RB 420</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=520" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB520.jpg"/>
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=520" target="_blank">4RB 520</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=620" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/4RB620.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("PROD_ROOT")); ?>/get4RBList?series=620" target="_blank">4RB 620</a>
												</h4>
										</div>
