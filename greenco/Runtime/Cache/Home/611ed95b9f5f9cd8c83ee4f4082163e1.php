...
<title><?php echo _('4RB Single Stage Side Channel Blower'); ?></title>
...
<form class="search-bar">
       ...
       <div class="col-md-9 split">
             <h3 class="title-1">
             		4RB <?php echo _('Single Stage'); echo _(' ▪ Side Channel Blower');?>
             </h3>
             <div class="row pro-list content">
             <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=210" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=210" target="_blank">4RB 210</a></h4></div>
		     <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=310" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=310" target="_blank">4RB 310</a></h4></div>
		     <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=410" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB210.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=410" target="_blank">4RB 410</a></h4></div>
		     <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=510" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB310.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=510" target="_blank">4RB 510</a></h4></div>
		     <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=610" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB310.jpg" /></a><h4><a href="Side_Channel_Blower_4RB_Single_Stage_table.php?series=610" target="_blank">4RB 610</a></h4></div>
