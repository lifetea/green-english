...
<title><?php echo _('3RB Three Stage Side Channel Blower'); ?></title>
...
<form class="search-bar">
		...
		<div class="form-group">
			...
			<div class="col-md-9 split">
       		<h3 class="title-1">
       				3RB <?php echo _('Three Stage'); echo _(' ▪ Side Channel Blower');?>
       		</h3>
       		<div class="row pro-list content">
			<?php require 'inc/3RB-desc.php';?>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=350-3" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/3RB350-3.jpg"/></a><h4><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=350-3" target="_blank">3RB 350</a></h4></div>
              <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=550-3"><img  src="<?php echo (C("IMG_ROOT")); ?>/3RB350-3.jpg"/></a><h4><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=550-3">3RB 550</a></h4></div>
              <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=750-3"><img  src="<?php echo (C("IMG_ROOT")); ?>/3RB350-3.jpg"/></a><h4><a href="Side_Channel_Blower_3RB_Three_Stage_table.php?series=750-3">3RB 750</a></h4></div>
