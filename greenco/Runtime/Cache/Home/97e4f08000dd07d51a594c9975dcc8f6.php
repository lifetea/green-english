...
<form class="search-bar">
       ...
       <div class="col-md-9  split">
             <h3 class="title-1"><?php echo _('Silencer for Side Channel Blower');?></h3>
             <div  id="mypage" class="col-md-4 pro-item"><a href="silencer_content.php?type=2BX4 011" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Silencer.png" alt="Side channel blower silencer 2BX4-011"/></a><h4><a href="silencer_content.php?type=2BX4 011" target="_blank"><?php echo _('Silencer');?> 2BX4-011</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="silencer_content.php?type=2BX4 012" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Silencer.png" alt="Side channel blower silencer 2BX4-012"/></a><h4><a href="silencer_content.php?type=2BX4 012" target="_blank"><?php echo _('Silencer');?> 2BX4-012</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="silencer_content.php?type=2BX4 013" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Silencer.png" alt="Side channel blower silencer 2BX4-013"/></a><h4><a href="silencer_content.php?type=2BX4 013" target="_blank"><?php echo _('Silencer');?> 2BX4-013</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="silencer_content.php?type=2BX4 014" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Silencer.png" alt="Side channel blower silencer 2BX4-014"/></a><h4><a href="silencer_content.php?type=2BX4 014" target="_blank"><?php echo _('Silencer');?> 2BX4-014</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="silencer_content.php?type=2BX4 015" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Silencer.png" alt="Side channel blower silencer 2BX4-015"/></a><h4><a href="silencer_content.php?type=2BX4 015" target="_blank"><?php echo _('Silencer');?> 2BX4-015</a></h4></div>
       </div>
   </div></div>
</div>
<!-- 应用内容end -->
