...
<form class="search-bar">
       ...
       <div class="col-md-9 split">
             <h3 class="title-1">
             		<?php echo _('Inlet Vacuum Filter for Side Channel Blower');?>
             </h3>
             <div class="row pro-list content">
             <div  id="mypage" class="col-md-4 pro-item"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 080" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/inlet_vacuum_filter_080.png" alt="Side channel blower inlet vacuum filter 2BX4-080"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 080" target="_blank">2BX4-080</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 081" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/inlet_vacuum_filter_081.png" alt="Side channel blower inlet vacuum filter 2BX4-081"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 081" target="_blank">2BX4-081</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 082" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/inlet_vacuum_filter_082.png" alt="Side channel blower inlet vacuum filter 2BX4-082"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 082" target="_blank">2BX4-082</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 083" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/inlet_vacuum_filter_083.png" alt="Side channel blower inlet vacuum filter 2BX4-083"/></a><h4><a href="Inlet_Vacuum_Filter_content.php?type=2BX4 083" target="_blank">2BX4-083</a></h4></div>
       </div>
   </div></div></div>
</div>
<!-- 应用内容end -->
