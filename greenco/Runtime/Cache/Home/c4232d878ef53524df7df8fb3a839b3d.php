								...
								<ul class="nav navbar-nav">
								  ...
								  <li class="dropdown">
								    ...
								    <ul class="dropdown-menu" role="menu">
								            ...
								            <li>
								            		<a href="<?php echo (C("PRO_ROOT")); ?>/Belt_4RB_1"><?php echo (L("HEADER_2RB_SINGLE_BELT")); ?></a>
								            </li>
								            <li class="divider">
								            <li>
								            		<a href="<?php echo (C("PRO_ROOT")); ?>/Belt_4RB_2"><?php echo (L("HEADER_2RB_DOUBLE_BELT")); ?></a>
								            </li>
								            <li>
...
<ul class="pro-nav">
	...
	<li>
		<a class="link-3" href="Belt_Drive_Air_Blower_2RB_Single_Stage.php"><?php echo _('2RB Single Stage Belt Drive Air Blower')?></a>
	</li>
	<li>
		<a class="link-3" href="Belt_Drive_Air_Blower_2RB_Double_Stage.php"><?php echo _('2RB Double Stage Belt Drive Air Blower')?></a>
	</li>
	<li>
...
<form class="search-bar">
		...
		<div class="form-group">
			...
			<div class="col-md-9 split">
             <h3 class="title-1">
             4RB <?php echo _('Three Stage'); echo _(' ▪ Side Channel Blower');?>
             </h3>
             <div class="row pro-list content">
             <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=530" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB530.jpg"/></a><h4><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=530" target="_blank">4RB 530</a></h4></div>
              <div  id="mypage" class="col-md-4 pro-item"><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=630" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/4RB630.jpg"/></a><h4><a href="Side_Channel_Blower_4RB_Three_Stage_table.php?series=630" target="_blank">4RB 630</a></h4></div>
