...
<?php
@define('feifa',ture); require 'inc/common.php'; $_result=mysql_query("select type,Fre_quency,output,maximum_airflow,maximum_vacuum,maximum_pressure  from product where  type like '%2RB <?php echo ($_GET['series']); ?>%' "); ?>
<!-- 应用内容 -->
