...
<form class="search-bar">
		...
		<div class="form-group">
            ...
            <div class="content">
            <h3 class="title-1">3RB <?php echo $_GET['series'];?> <?php echo _('Series Ordering Data and Performance Data');?></h3>
		...
		<td>mbar</td>
					...
					<tfoot>
						<tr>
							<td colspan=6>
									<p>
											<a class="link-1" href="<?php echo (L("SRC_LAN")); ?>/3rb_<?php echo substr($_GET['series'],0,5)?>.pdf" target="_blank" >
