		...
		<div class="form-group">
		    <button type="submit" class="btn btn-default"><?php echo (L("HEADER_SEARCH")); ?></button>
						...
						<div class="col-md-9 split">
								<h3 class="title-1">2RB <?php echo (L("PROD_DOUBLE_STAGE")); ?> ▪ <?php echo (L("Belt_2RB_REGENERATIVE_BLOWER")); ?></h3>
								<div class="row pro-list content">
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB223.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_223.jpg"/>
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB223.pdf" target="_blank">2RB 223-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB423.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_423.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB423.pdf" target="_blank">2RB 423-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB523.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_523.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB523.pdf" target="_blank">2RB 523-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB723.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_523.jpg"/>
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB723.pdf" target="_blank">2RB 723-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB743.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_743.jpg"  />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB743.pdf" target="_blank">2RB 743-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB823.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_823.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB823.pdf" target="_blank">2RB 823-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item">
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB923.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_923.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB923.pdf" target="_blank">2RB 923-1HY99</a>
												</h4>
										</div>
										<div  id="mypage" class="col-md-4 pro-item" >
												<a href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB943.pdf" target="_blank">
														<img  src="<?php echo (C("IMG_ROOT")); ?>/2RB_Belt_943.jpg" />
												</a>
												<h4>
														<a class="link-4" href="<?php echo (C("SRC_ROOT")); ?>/pdf/Belt_2RB943.pdf" target="_blank">2RB 943-1HY99</a>
												</h4>
										</div>
