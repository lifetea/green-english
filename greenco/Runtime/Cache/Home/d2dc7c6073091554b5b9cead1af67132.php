...
<form class="search-bar">
       ...
       <div class="col-md-9 split">
             <h3 class="title-1"><?php echo _('Relief Valve for Side Channel Blower')?>
			 </h3>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=RV-01" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_RV.jpg" alt="side channel blower Relief Valve RV"/></a><h4><a href="Relief_valve_content.php?type=RV-01" target="_blank"><?php echo _('Relief Valve')?> RV-01</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=RV-02" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_RV.jpg" alt="side channel blower Relief Valve RV"/></a><h4><a href="Relief_valve_content.php?type=RV-02" target="_blank"><?php echo _('Relief Valve')?> Valve RV-02</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=2BX4 141" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_2BX141.jpg" alt="side channel blower Relief Valve 2BX4-141"/></a><h4><a href="Relief_valve_content.php?type=2BX4 141" target="_blank"><?php echo _('Relief Valve')?> 2BX4-141</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=2BX4 142" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_2BX142.jpg" alt="side channel blower Relief Valve 2BX4-142"/></a><h4><a href="Relief_valve_content.php?type=2BX4 142" target="_blank"><?php echo _('Relief Valve')?> 2BX4-142</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=2BX4 143" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_2BX143.jpg" alt="side channel blower Relief Valve 2BX4-143"/></a><h4><a href="Relief_valve_content.php?type=2BX4 143" target="_blank"><?php echo _('Relief Valve')?> 2BX4-143</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=2BX4 144" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_2BX144.jpg" alt="side channel blower Relief Valve 2BX4-144"/></a><h4><a href="Relief_valve_content.php?type=2BX4 144" target="_blank"><?php echo _('Relief Valve')?> 2BX4-144</a></h4></div>
             <div  id="mypage" class="col-md-4 pro-item"><a href="Relief_valve_content.php?type=2BX4 145" target="_blank"><img  src="<?php echo (C("IMG_ROOT")); ?>/Relief_Valve_2BX145.jpg" alt="side channel blower Relief Valve 2BX4-145"/></a><h4><a href="Relief_valve_content.php?type=2BX4 145" target="_blank"><?php echo _('Relief Valve')?> 2BX4-145</a></h4></div>
       </div>
   </div>
</div>
<!-- 应用内容end -->
