...
<nav role="navigation" class="<?php echo _('greenco-nav')?> clearfix">
  <ul class="main-nav"  >
      <li style="margin-left:10px;">
        ...
        <li>
          <a href="about_us.php"><?php echo _('About us')?></a>
            <div class="dropdown">
              <ul>
                  <li><a rel="nofollow" href="about_us.php"><?php echo _('About Greenco')?></a></li>
        ...
        <li>
          <a href="Side_Channel_Blower_2RB_Single_Stage.php"><?php echo _('Products')?></a>
            ...
            <div class="dropdown" style="width:248px;">
              <ul>
                  ...
                  <li><a href="Liquid_Ring_Vacuum_Pump_2LV7.php"><?php echo _('Liquid Ring Vacuum Pump')?></a></li>
        ...
        <li>
          <a rel="nofollow" href="news_company.php"><?php echo _('News & Information')?></a>
   ...
   <form  action="Side_Channel_Blower_Search_table.php" id="search" method="post">
	  <input  id="term" name="term" placeholder="<?php echo _('Start Searching')?> ..." type="text"  style="border-radius:0px;"/>
	  <button type="submit" class="image-button search no-margin"><?php echo _('Search')?></button>
  </form>
    </li>
  </ul>
</nav>
