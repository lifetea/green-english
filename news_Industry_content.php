...
<style>
    ...
    #Side_Channel_Blower_2RB_Single_Stage_all{background:#ccc;}
  	#Side_Channel_Blower_2RB_Single_Stage{padding-bottom:20px;height:auto;width:1000px;margin:0 auto;background:#fff;border:1px solid #999;border-top:none;}
    #Side_Channel_Blower_2RB_Single_Stage .left{float:left;width:265px;margin:5px 0 0 10px;}
  	#Side_Channel_Blower_2RB_Single_Stage .left H2{text-indent:10px;background:#666;font-size:14px;font-weight:600;width:250px;height:20px;color:#fff;line-height:20px;border:1px solid  #555;}
	...
	#Side_Channel_Blower_2RB_Single_Stage .right{float:left;width:700px;border-left:1px solid #ccc;padding:0 0 0 15px;}
   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="left">
             <h2 style="margin-top:5px;font-family:tahoma;">NEWS</h2>
                 <ul>
	                  <li style="margin-top:-2px;"><a href="Enterprise_news.php">Company news</a></li>
