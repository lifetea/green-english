...
<style>
   ...
   #Certification _all{background:#ccc;}
  	#Certification {height:920px;width:1000px;margin:0 auto;background:#fff;border:1px solid #999;border-top:none;box-shadow:0px 5px 7px 5px #ccc;}
    #Certification  .left{float:left;width:265px;margin:5px 0 0 10px;padding-bottom:60px;}
  	#Certification  .left H2{text-indent:8px;background:#666;font-size:14px;font-weight:600;width:250px;height:32px;color:#fff;line-height:32px;border:1px solid  #555;}
  	#Certification  .left ul{margin-top:8px;list-style:none;}
  	#Certification  .left ul li {margin-top:13px;background:url(image/jiantou.png) no-repeat 0 2px;padding-left:18px;}
    #Certification  .left form p{margin-top:10px;width:240px;padding-left:10px;}
  	#Certification  .left ul li  a{color:#333;}
  	#Certification  .left .text{border-radius:0px;}
  	#Certification  .left select{margin-left:8px;border-radius:0px;}
	#Certification  .right{height:670px;float:left;width:700px;border-left:1px solid #ccc;padding:0 0 30px 15px;}
    #Certification  .right h5{margin-top:10px;border-bottom:1px solid #ccc;height:30px;line-height:30px;color:#1b347e;}
	#Certification  .right p{padding:3px;line-height:21px;text-indent:20px;}
  	#Certification  .right img{width:100px;height:150px;border:1px solid #999;border-bottom:2px solid #666;}
    #Certification  .right img:hover{filter:alpha(opacity=90);opacity=0.9;}
  	#Certification .right .Certification_image{float:left;margin:30px 0 0 60px;}
  	#Certification .right .Certification_image p{text-indent:10px;}
  	#Certification .right  a{color:#333;}
