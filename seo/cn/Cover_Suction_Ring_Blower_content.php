...
$_result=mysql_query("select type,sound_level,Fre_quency,output,maximum_airflow,maximum_vacuum,maximum_pressure,weight,phases,Inlet_outlet,A,A1,B,B1,C,C1,D,E,F,F1,F11,G,H,H1,J,K,L,M,N,N1,O,P,Q,ϕR,S,U,V,V1,V1_,V3,V3_,Y_Z,X_Holes,ϕX,W  from b_series where  type like '%{$_GET['series']}%' and output={$_GET['output']} ");
...
<title><?php  echo $_GET['series'];?> 吸顶式旋涡风机|旋涡气泵</title>
...
<style>
    ...
    table.data span{vertical-align:bottom;font-size:10px;color:#333;}
  	table.data tr.one{background:url(image/table_bg.png);font-size:11px;}
   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
              <div id="left">
                ...
                <?php  if($_rows['type']=='2RB 810-7AH07' or $_rows['type']=='2RB 810-7AH17' or $_rows['type']=='2RB 810-7AH27' or $_rows['type']=='2RB 830-7AH07' or $_rows['type']=='2RB 830-7AH17' or $_rows['type']=='2RB 830-7AH27'){echo $_rows['F1'].'×'.$_rows['A'].'×'.$_rows['B1'];}
             ...
             <div id="right">
                <img src="product_image/product_content_big/Cover_Suction_Ring_Blower.jpg" alt="Cover Suction Ring Blower"/>
             </div>
             ...
             <!-- 尺寸图判断 -->
             <?php
	             if($_rows['type']=='2RB 810-7BH07' or $_rows['type']=='2RB 810-7BH17' or $_rows['type']=='2RB 810-7BH27'){echo       '<a rel="shadowbox" href="product_image/dimensions/2RB810_big.jpg"><img alt="Dimension for side channel blower '.$_rows['type'].' " class="border" src="product_image/dimensions/2RB810_small.jpg"  title="Click to Enlarge"/></a>';}
	             else{ echo  '<a rel="shadowbox" href="product_image/dimensions/2RB210_big.jpg"><img alt="Dimension for side channel blower '.$_rows['type'].' " class="border" src="product_image/dimensions/2RB210_small.jpg"  title="Click to Enlarge"/></a>';}
             ?>

             <!-- 尺寸图技术参数判断 -->
             <?php  if($_rows['type']=='2RB 810-7BH07' or $_rows['type']=='2RB 810-7BH17' or $_rows['type']=='2RB 810-7BH27' ){
