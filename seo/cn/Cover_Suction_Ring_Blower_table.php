...
<title>2RB <?php  echo $_GET['series'];?> 吸顶式旋涡风机|旋涡气泵<</title>
...
<style>
    ...
    #Side_Channel_Blower_2RB_Single_Stage .right h3 {margin-top:20px;background:url(image/download.png) no-repeat  120px 9px;}
  	#Side_Channel_Blower_2RB_Single_Stage .right h3 a{font-style:italic;display:block;text-decoration:underline;color:#26428A;font-size:14px;text-indent:140px;font-weight:900;height:35px;line-height:35px;}
   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
             ...
             <table  cellspacing="0" cellpadding="0" id="data">
                 ...
                 <h3><a href="upfile/B_series/Side channel blower 2rb<?php echo substr($_GET['series'],0,3)?>(B).pdf" target="_blank" >Download Cover_Suction_Ring_Blower  2RB<?php echo substr($_GET['series'],0,3)?> Series(PDF-<?php $type=$_GET['series'];$filename ='upfile/B_Series/side channel blower 2RB'.$type.'(B).PDF'; echo floor(filesize($filename)/1024);?>KB)</a></h3>
       </div>
   </div>
</div>
<!-- 应用内容end -->
