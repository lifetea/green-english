...
<body>
  <!--百度地图容器-->
  <div style="width:710px;height:300px;border:#ccc solid 1px;margin-top:10px;" id="dituContent"></div>
  ...
  <script type="text/javascript">
    ...
    function createIcon(json){
        var icon = new BMap.Icon("image/ditu.jpg", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
        return icon;
    }
