   ...
   <div id="Side_Channel_Blower_2RB_Single_Stage">
       ...
       <div class="right">
              <div id="left">
                ...
                <td><strong><?php echo _('Power');?>:</strong> <span><?php echo $_rows['output'];?></span> (Kw)</td>
                <td><tr><td><strong><?php echo _('Airflow');?>:</strong> <span><?php echo $_rows['maximum_airflow'];?></span> (m³/h)</td>
                ...
                <tr><td><strong><?php echo _('Dimension');?>(L*W*H):</strong> <span><?php echo $_rows['F'].'×'.$_rows['A'].'×'.$_rows['B1'];?></span> (mm)</td><td>
                </table>
             </div>
             <div id="right">
