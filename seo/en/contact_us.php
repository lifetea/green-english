...
<div id="contact_all">
    ...
    <img src="images/contact_us.jpg" style="position:absolute;right:140px;top:25px;"/>
	    ...
	    <div id="contact_info">
             ...
             <p><?php echo _('Tel');?>: 0086-576-86428999</p>
             <p><?php echo _('Fax');?>: 0086-576-86409555</p>
	     ...
	     <div id="feedback_info">
              ...
              <form method="post"  action="contact_us.php">
	              <table>
		              ...
		              <tr><td><?php echo _('Telephone');?>:</td><td style="text-align:left;"><input name="phone" type="text"/></td></tr>
