...
<script type="text/javascript">
	$(function(){
		...
		$("#Side_Channel_Blower_2RB_Single_Stage").height(a+330);
	})
</script>
<style>
	...
	#Side_Channel_Blower_2RB_Single_Stage .right{float:left;width:700px;border-left:1px solid #ccc;padding:0 0 20px 15px;}
  	...
  	#Side_Channel_Blower_2RB_Single_Stage .right  p{margin-top:10px;font-family:tahoma;line-height:30px;color:#222;}
  	#Side_Channel_Blower_2RB_Single_Stage .right  table{margin:15px 0 20px 20px;float:left;}
  	#Side_Channel_Blower_2RB_Single_Stage .right  table td{padding:5px 15px 5px 15px;border:1px solid #bbb;}
...
$(function(){
    ...
    $('table tr.one').css('background','#faf09c').css('color','#222');
